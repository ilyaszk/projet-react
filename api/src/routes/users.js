import {getScoreBoard, getUserById, getUsers, loginUser, registerUser,} from "../controllers/users.js";
...
//récupérer les scores
    app.get("/users/scoreBoard", async (request, reply) => {
        reply.send(await getScoreBoard());
    });
